...
CREATE TABLE Etudiant (idEtu_Etudiant INT(11) AUTO_INCREMENT NOT NULL,
...
CREATE TABLE Enseignant (idEns_Enseignant INT(11) AUTO_INCREMENT NOT NULL,
...
CREATE TABLE Salle (idS_Salle INT(11) AUTO_INCREMENT NOT NULL,
nomS_Salle VARCHAR(250),
PRIMARY KEY (idS_Salle)) ENGINE=InnoDB;

DROP TABLE IF EXISTS Entretien ;
CREATE TABLE Entretien (idEnt_Entretien INT(11) AUTO_INCREMENT NOT NULL,
...
CREATE TABLE DispoEnseignant (idDEns_DispoEnseignant INT(11) AUTO_INCREMENT NOT NULL,
...
CREATE TABLE Type_Session (idT_Type_Session INT(11) AUTO_INCREMENT NOT NULL,
descriptionT_Type_Session VARCHAR(250),
PRIMARY KEY (idT_Type_Session)) ENGINE=InnoDB;

DROP TABLE IF EXISTS Critere ;
CREATE TABLE Critere (idC_Critere INT(11) AUTO_INCREMENT NOT NULL,
descriptionC_Critere VARCHAR(250),
niveauEval_Critere INT(11),
PRIMARY KEY (idC_Critere)) ENGINE=InnoDB;

DROP TABLE IF EXISTS Resultat ;
CREATE TABLE Resultat (idR_Resultat INT(11) AUTO_INCREMENT NOT NULL,
noteR_Resultat INT(11),
...
CREATE TABLE Horaires (idH_Horaires INT(11) AUTO_INCREMENT NOT NULL,
dateH_Horaires DATE,
...
CREATE TABLE Possede (idT_Type_Session INT(11) AUTO_INCREMENT NOT NULL,
...
ALTER TABLE Possede ADD CONSTRAINT FK_Possède_idT_Type_Session FOREIGN KEY (idT_Type_Session) REFERENCES Type_Session (idT_Type_Session);
ALTER TABLE Possede ADD CONSTRAINT FK_Possède_idC_Critere FOREIGN KEY (idC_Critere) REFERENCES Critere (idC_Critere);
